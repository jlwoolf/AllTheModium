...
public class PVStructure extends Structure {
	...
	public static final Codec<PVStructure> CODEC = RecordCodecBuilder
			.<PVStructure>mapCodec(instance -> instance
					.group(
							PVStructure.settingsCodec(instance),
	 ...
	 * Then loop through it and look for land with air above it and set block pos's Y value to it.
	 * Make sure to set the final boolean in JigsawPlacement.addPieces to false so
	 * that the structure spawns at block pos's y value instead of placing the structure on the Bedrock roof!
	 *
