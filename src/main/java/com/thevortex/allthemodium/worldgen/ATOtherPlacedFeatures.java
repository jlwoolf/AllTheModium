...
public class ATOtherPlacedFeatures {
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_COAL =
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_COPPER =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_DIAMOND =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_EMERALD =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_GOLD =
        PlacementUtils.register(
            "allthemodium:ore_gold",
            ATOOtherFeatures.OTHER_ORE_GOLD,
            commonOrePlacement(20, PlacementUtils.RANGE_10_10)
        );
    public static final Holder<PlacedFeature> OTHER_ORE_IRON =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_LAPIS =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> OTHER_ORE_QUARTZ =
        PlacementUtils.register(
            "allthemodium:ore_quartz",
            ATOOtherFeatures.OTHER_ORE_QUARTZ,
            commonOrePlacement(16, PlacementUtils.RANGE_10_10)
        );
    public static final Holder<PlacedFeature> OTHER_ORE_REDSTONE =
        PlacementUtils.register(
