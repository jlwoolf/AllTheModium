...
public class ATMPlacedFeature {
    ...
    public static final Holder<PlacedFeature> ORE_ALLTHEMODIUM =
    ...
    public static final Holder<PlacedFeature> ORE_ALLTHEMODIUM_MOUNTAIN =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> ORE_ATM_MINING =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> ORE_VIBRANIUM =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> ORE_VIBRANIUM_OTHER =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> ORE_UNOBTAINIUM =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> DEMONIC_TREE =
        PlacementUtils.register(
            "allthemodium:demonic_tree",
            ATMConfiguredFeature.DEMONIC_TREE,
            treePlacement(PlacementUtils.countExtra(2, 0.1F, 1))
        );
    public static final Holder<PlacedFeature> DEMONIC_TREE_MEDIUM =
        PlacementUtils.register(
            "allthemodium:demonic_tree_medium",
            ATMConfiguredFeature.DEMONIC_TREE_MEDIUM,
            treePlacement(PlacementUtils.countExtra(2, 0.1F, 1))
        );
    public static final Holder<PlacedFeature> DEMONIC_TREE_GIANT =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> SOUL_TREE =
        PlacementUtils.register(
            "allthemodium:soul_tree",
            ATMConfiguredFeature.SOUL_TREE,
            treePlacement(PlacementUtils.countExtra(2, 0.1F, 1))
        );
    public static final Holder<PlacedFeature> SOUL_TREE_MEDIUM =
        PlacementUtils.register(
            "allthemodium:soul_tree_medium",
            ATMConfiguredFeature.SOUL_TREE_MEDIUM,
            treePlacement(PlacementUtils.countExtra(2, 0.1F, 1))
        );
    public static final Holder<PlacedFeature> SOUL_TREE_GIANT =
        PlacementUtils.register(
    ...
    public static final Holder<PlacedFeature> CAVE_ATM =
        PlacementUtils.register(
