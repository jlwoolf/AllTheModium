...
public class ATMConfiguredFeature {
    ...
    > ORE_ALLTHEMODIUM_TARGET_LIST = ImmutableList.of(
    ...
    public static final OreConfiguration ORE_ALLTHEMODIUM_CONFIG =
        new OreConfiguration(ORE_ALLTHEMODIUM_TARGET_LIST, 4);

    public static Holder<
        ConfiguredFeature<OreConfiguration, ?>
    > ORE_ALLTHEMODIUM = FeatureUtils.register(
    ...
    public static Holder<
        ConfiguredFeature<OreConfiguration, ?>
    > ORE_ATM_MINING = FeatureUtils.register(
        "allthemodium:ore_atm_mining",
        Feature.ORE,
        ORE_ALLTHEMODIUM_CONFIG
    );

    public static Holder<ConfiguredFeature<OreConfiguration, ?>> ORE_VIBRANIUM =
    ...
    public static Holder<
        ConfiguredFeature<OreConfiguration, ?>
    > OTHER_ORE_VIBRANIUM = FeatureUtils.register(
    ...
    public static Holder<
        ConfiguredFeature<OreConfiguration, ?>
    > ORE_UNOBTAINIUM = FeatureUtils.register(
    ...
    public static Holder<ConfiguredFeature<VolcanoConfig, ?>> VOLCANO_CF =
        FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<DeltaFeatureConfiguration, ?>
    > MOD_DELTAS = FeatureUtils.register(
    ...
    > ANCIENT_TREE_GIANT = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > ANCIENT_TREE_MEDIUM = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > ANCIENT_TREE = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > DEMONIC_TREE_GIANT = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > DEMONIC_TREE_MEDIUM = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > DEMONIC_TREE = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > SOUL_TREE_GIANT = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > SOUL_TREE_MEDIUM = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<TreeConfiguration, ?>
    > SOUL_TREE = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<BlockColumnConfiguration, ?>
    > CAVE_VINE = FeatureUtils.register(
    ...
    public static final Holder<
        ConfiguredFeature<RandomPatchConfiguration, ?>
    > PATCH_ANCIENT_HERB = FeatureUtils.register(
