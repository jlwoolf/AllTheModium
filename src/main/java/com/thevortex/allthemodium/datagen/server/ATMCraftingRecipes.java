...
public class ATMCraftingRecipes extends RecipeProvider {
    ...
    protected void buildShapedRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        shaped(ModRegistry.ALLTHEMODIUM_APPLE.get())
                ...
                .unlockedBy("has_allthemodium_nugget",
                        RecipeProvider.inventoryTrigger(
                                ItemPredicate.Builder.item().of(TagRegistry.ALLTHEMODIUM_NUGGET).build()))
                .save(consumer);
        ...
        shaped(ModRegistry.TELEPORT_PAD_ITEM.get())
                ...
                .unlockedBy("has_ender_pearl",
                        RecipeProvider.inventoryTrigger(ItemPredicate.Builder.item().of(Items.ENDER_PEARL).build()))
                .save(consumer);
        ...
        shaped(ModRegistry.ALLTHEMODIUM_PICKAXE.get())
                ...
                .unlockedBy("has_allthemodium_rod",
                        RecipeProvider.inventoryTrigger(
    ...
    protected void buildBlastingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.ANCIENT_STONE_ITEM.get()), RecipeCategory.MISC,
                        ModRegistry.ANCIENT_SMOOTH_STONE_ITEM.get(), 0.15f, 200)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.RAW_ALLTHEMODIUM.get()), RecipeCategory.MISC,
                        ModRegistry.ALLTHEMODIUM_INGOT.get(), 0.15f, 200)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.RAW_VIBRANIUM.get()), RecipeCategory.MISC,
                        ModRegistry.VIBRANIUM_INGOT.get(), 0.15f, 200)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.RAW_UNOBTAINIUM.get()), RecipeCategory.MISC,
                        ModRegistry.UNOBTAINIUM_INGOT.get(), 0.15f, 200)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.ALLTHEMODIUM_DUST.get()), RecipeCategory.MISC,
                        ModRegistry.ALLTHEMODIUM_INGOT.get(), 0.15f, 200)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.VIBRANIUM_DUST.get()), RecipeCategory.MISC,
                        ModRegistry.VIBRANIUM_INGOT.get(), 0.15f, 200)
        ...
        SimpleCookingRecipeBuilder
                .blasting(Ingredient.of(ModRegistry.UNOBTAINIUM_DUST.get()), RecipeCategory.MISC,
                        ModRegistry.UNOBTAINIUM_INGOT.get(), 0.15f, 200)
    ...
    protected void buildShapelessRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy(hasCondition,
                        RecipeProvider.inventoryTrigger(
                                ItemPredicate.Builder.item().of(TagRegistry.ANCIENT_STONE_BRICKS_ITEM).build()))
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy(hasCondition,
                        RecipeProvider.inventoryTrigger(
                                ItemPredicate.Builder.item().of(TagRegistry.ANCIENT_CRACKED_STONE_BRICKS_ITEM).build()))
    ...
    protected void buildSmeltingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.ANCIENT_STONE_ITEM.get()), RecipeCategory.MISC,
                        ModRegistry.ANCIENT_SMOOTH_STONE_ITEM.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.ANCIENT_STONE_ITEM.get()))
                .save(consumer, recipeDir("ancient_smooth_stone", "ancient_stone_smelting"));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.RAW_ALLTHEMODIUM.get()), RecipeCategory.MISC,
                        ModRegistry.ALLTHEMODIUM_INGOT.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.RAW_ALLTHEMODIUM.get()))
                .save(consumer, recipeDir("allthemodium_ingot", "raw_smelting"));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.RAW_VIBRANIUM.get()), RecipeCategory.MISC,
                        ModRegistry.VIBRANIUM_INGOT.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.RAW_VIBRANIUM.get()))
                .save(consumer, recipeDir("vibranium_ingot", "raw_smelting"));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.RAW_UNOBTAINIUM.get()), RecipeCategory.MISC,
                        ModRegistry.UNOBTAINIUM_INGOT.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.RAW_UNOBTAINIUM.get()))
                .save(consumer, recipeDir("unobtainium_ingot", "raw_smelting"));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.ALLTHEMODIUM_DUST.get()), RecipeCategory.MISC,
                        ModRegistry.ALLTHEMODIUM_INGOT.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.ALLTHEMODIUM_DUST.get()))
                .save(consumer, recipeDir("allthemodium_ingot", "dust_smelting"));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.VIBRANIUM_DUST.get()), RecipeCategory.MISC,
                        ModRegistry.VIBRANIUM_INGOT.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.VIBRANIUM_DUST.get()))
                .save(consumer, recipeDir("vibranium_ingot", "dust_smelting"));

        SimpleCookingRecipeBuilder
                .smelting(Ingredient.of(ModRegistry.UNOBTAINIUM_DUST.get()), RecipeCategory.MISC,
                        ModRegistry.UNOBTAINIUM_INGOT.get(), 0.15f, 200)
                .unlockedBy(hasCondition, RecipeProvider.has(ModRegistry.UNOBTAINIUM_DUST.get()))
