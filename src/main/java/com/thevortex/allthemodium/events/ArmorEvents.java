    ...
    public static void onPlayerFall(LivingFallEvent event) {
        ...
        while (iterator.hasNext()) {
            ...
            if ((armor.getItem() == ModRegistry.ALLTHEMODIUM_BOOTS.get())
                    || (armor.getItem() == ModRegistry.VIBRANIUM_BOOTS.get())
                    || (armor.getItem() == ModRegistry.UNOBTAINIUM_BOOTS.get())) {
        ...
        if (!entity.getCommandSenderWorld().isClientSide()) {
            ...
            while (iterator.hasNext()) {
                ...
                if ((armor.getItem() == ModRegistry.ALLTHEMODIUM_CHESTPLATE.get())
                        || (armor.getItem() == ModRegistry.VIBRANIUM_CHESTPLATE.get())
                        || (armor.getItem() == ModRegistry.UNOBTAINIUM_CHESTPLATE.get())) {
                ...
                if ((armor.getItem() == ModRegistry.ALLTHEMODIUM_HELMET.get())
                        || (armor.getItem() == ModRegistry.VIBRANIUM_HELMET.get())
                        || (armor.getItem() == ModRegistry.UNOBTAINIUM_HELMET.get())) {
