...
public class FluidTypeRegistry {
    ...
    public static final RegistryObject<FluidType> SOULLAVA = FLUID_TYPES.register("soul_lava",
            () -> new SoulLavaType(FluidType.Properties.create()
    ...
    public static final RegistryObject<FluidType> ATM = FLUID_TYPES.register("molten_atm",
            () -> new MoltenATMType(FluidType.Properties.create()
    ...
    public static final RegistryObject<FluidType> VIB = FLUID_TYPES.register("molten_vibranium",
            () -> new MoltenVIBType(FluidType.Properties.create()
    ...
    public static final RegistryObject<FluidType> UNOB = FLUID_TYPES.register("molten_unobtainium",
            () -> new MoltenUNOBType(FluidType.Properties.create()
