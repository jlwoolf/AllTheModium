...
public class TagRegistry {
    ...
    public static final TagKey<Block> NEEDS_UNOBTAINIUM_TOOL = BlockTags
            .create(Reference.forge("needs_unobtainium_tool"));
    public static final TagKey<Block> NEEDS_ALLOY_TOOL = BlockTags
            .create(Reference.forge("needs_allthemodiumalloy_tool"));
    ...
    public static final TagKey<Block> OTHER_TILE_WHITELIST = BlockTags
            .create(Reference.location("allthemodium:other_te_whitelist"));
    public static final TagKey<Block> ANCIENT_DIRT = BlockTags.create(Reference.location("allthemodium:ancient_dirt"));
    public static final TagKey<Block> ANCIENT_STONE = BlockTags
            .create(Reference.location("allthemodium:ancient_stone"));
    public static final TagKey<Item> ANCIENT_STONE_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_stone"));
    public static final TagKey<Block> ANCIENT_WOODEN_PLANKS = BlockTags
            .create(Reference.location("allthemodium:ancient_planks"));
    public static final TagKey<Item> ANCIENT_WOODEN_PLANKS_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_planks"));
    public static final TagKey<Block> DEMONIC_WOODEN_PLANKS = BlockTags
            .create(Reference.location("allthemodium:demonic_planks"));
    public static final TagKey<Item> DEMONIC_WOODEN_PLANKS_ITEM = ItemTags
            .create(Reference.location("allthemodium:demonic_planks"));
    public static final TagKey<Block> SOUL_WOODEN_PLANKS = BlockTags
            .create(Reference.location("allthemodium:soul_planks"));
    public static final TagKey<Item> SOUL_WOODEN_PLANKS_ITEM = ItemTags
            .create(Reference.location("allthemodium:soul_planks"));

    public static final TagKey<Block> ANCIENT_MOSSY_STONE = BlockTags
            .create(Reference.location("allthemodium:ancient_mossy_stone"));
    public static final TagKey<Item> ANCIENT_MOSSY_STONE_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_mossy_stone"));
    public static final TagKey<Block> ANCIENT_SMOOTH_STONE = BlockTags
            .create(Reference.location("allthemodium:ancient_smooth_stone"));
    public static final TagKey<Item> ANCIENT_SMOOTH_STONE_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_smooth_stone"));
    public static final TagKey<Block> ANCIENT_POLISHED_STONE = BlockTags
            .create(Reference.location("allthemodium:ancient_polished_stone"));
    public static final TagKey<Item> ANCIENT_POLISHED_STONE_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_polished_stone"));
    public static final TagKey<Block> ANCIENT_STONE_BRICKS = BlockTags
            .create(Reference.location("allthemodium:ancient_stone_bricks"));
    public static final TagKey<Item> ANCIENT_STONE_BRICKS_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_stone_bricks"));
    public static final TagKey<Block> ANCIENT_CRACKED_STONE_BRICKS = BlockTags
            .create(Reference.location("allthemodium:ancient_cracked_stone_bricks"));
    public static final TagKey<Item> ANCIENT_CRACKED_STONE_BRICKS_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_cracked_stone_bricks"));
    public static final TagKey<Block> ANCIENT_CHISELED_STONE_BRICKS = BlockTags
            .create(Reference.location("allthemodium:ancient_chiseled_stone_bricks"));
    public static final TagKey<Item> ANCIENT_CHISELED_STONE_BRICKS_ITEM = ItemTags
            .create(Reference.location("allthemodium:ancient_chiseled_stone_bricks"));
