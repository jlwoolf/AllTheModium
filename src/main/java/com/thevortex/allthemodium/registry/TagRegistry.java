...
public class TagRegistry {
    ...
    public static final TagKey<Block> NEEDS_ALLTHEMODIUM_TOOL =
        BlockTags.create(Reference.forge("needs_allthemodium_tool"));
    ...
    public static final TagKey<Item> ANCIENT_WOODEN_PLANKS_ITEM =
        ItemTags.create(Reference.location("allthemodium:ancient_planks"));
    public static final TagKey<Block> DEMONIC_WOODEN_PLANKS = BlockTags.create(
        Reference.location("allthemodium:demonic_planks")
    );
    public static final TagKey<Item> DEMONIC_WOODEN_PLANKS_ITEM =
        ItemTags.create(Reference.location("allthemodium:demonic_planks"));
    ...
    public static final TagKey<Item> ANCIENT_SMOOTH_STONE_ITEM =
        ItemTags.create(
            Reference.location("allthemodium:ancient_smooth_stone")
        );
    ...
    public static final TagKey<Item> ANCIENT_POLISHED_STONE_ITEM =
        ItemTags.create(
            Reference.location("allthemodium:ancient_polished_stone")
        );
    ...
    public static final TagKey<Item> ANCIENT_STONE_BRICKS_ITEM =
        ItemTags.create(
            Reference.location("allthemodium:ancient_stone_bricks")
        );
    public static final TagKey<Block> ANCIENT_CRACKED_STONE_BRICKS =
        BlockTags.create(
            Reference.location("allthemodium:ancient_cracked_stone_bricks")
        );
    public static final TagKey<Item> ANCIENT_CRACKED_STONE_BRICKS_ITEM =
        ItemTags.create(
            Reference.location("allthemodium:ancient_cracked_stone_bricks")
        );
    public static final TagKey<Block> ANCIENT_CHISELED_STONE_BRICKS =
        BlockTags.create(
            Reference.location("allthemodium:ancient_chiseled_stone_bricks")
        );
    public static final TagKey<Item> ANCIENT_CHISELED_STONE_BRICKS_ITEM =
        ItemTags.create(
            Reference.location("allthemodium:ancient_chiseled_stone_bricks")
        );
    ...
    public static final TagKey<Item> VIBRANIUM_ALLTHEMODIUM_INGOT =
        ItemTags.create(Reference.ingot("vibranium_allthemodium_alloy"));
    public static final TagKey<Item> UNOBTAINIUM_VIBRANIUM_INGOT =
        ItemTags.create(Reference.ingot("unobtainium_vibranium_alloy"));
    public static final TagKey<Item> UNOBTAINIUM_ALLTHEMODIUM_INGOT =
        ItemTags.create(Reference.ingot("unobtainium_allthemodium_alloy"));

    public static final TagKey<Item> VIBRANIUM_ALLTHEMODIUM_BLOCK =
        ItemTags.create(Reference.block("vibranium_allthemodium_alloy"));
    public static final TagKey<Item> UNOBTAINIUM_VIBRANIUM_BLOCK =
        ItemTags.create(Reference.block("unobtainium_vibranium_alloy"));
    public static final TagKey<Item> UNOBTAINIUM_ALLTHEMODIUM_BLOCK =
        ItemTags.create(Reference.block("unobtainium_allthemodium_alloy"));
