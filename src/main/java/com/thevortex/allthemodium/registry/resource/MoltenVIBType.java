...
public class MoltenVIBType extends FluidType {
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            ...
            private static final ResourceLocation FLUID_STILL = ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "block/fluid/vibranium_molten_still");
            private static final ResourceLocation FLUID_FLOW = ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "block/fluid/vibranium_molten_flow");
            private static final ResourceLocation FLUID_OVERLAY = ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "block/fluid/vibranium_molten_still");
