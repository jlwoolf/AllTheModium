...
public class Vibranium_Ore extends DropExperienceBlock {
	...
	public Vibranium_Ore() {//func_235861_h_ = setRequiresTool
		super(Properties.of(Material.STONE).requiresCorrectToolForDrops().sound(SoundType.NETHER_ORE).strength(
			AllthemodiumCommonConfigs.VIBRANIUM_QUARRYABLE.get() ? 80.0f : -1.0f, 5000f
		));
	}
	@Override
