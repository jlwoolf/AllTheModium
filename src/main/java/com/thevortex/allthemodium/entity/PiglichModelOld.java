...
public class PiglichModelOld<T extends Mob> extends PlayerModel<T> {
    ...
    @Override
    public void renderEars(@Nonnull PoseStack stack, @Nonnull VertexConsumer consumer, int p_103404_, int p_103405_) {
        super.renderEars(stack, consumer, p_103404_, p_103405_);
    }

    @Override
    public void renderCloak(@Nonnull PoseStack p_103412_, @Nonnull VertexConsumer p_103413_, int p_103414_,
            int p_103415_) {
    ...
    public void setupAnim(@Nonnull T p_103366_, float p_103367_, float p_103368_, float p_103369_, float p_103370_,
            float p_103371_) {
    ...
    @Override
    public void prepareMobModel(@Nonnull T p_102861_, float p_102862_, float p_102863_, float p_102864_) {
