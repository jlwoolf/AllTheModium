...
public class PiglichEntity extends Piglin implements GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<Skeleton>(this, Skeleton.class, true));
        this.targetSelector.addGoal(1,
                new NearestAttackableTargetGoal<WitherSkeleton>(this, WitherSkeleton.class, true));
    ...
    @Override
    public SpawnGroupData finalizeSpawn(@Nonnull ServerLevelAccessor sla,
            @Nonnull DifficultyInstance difficultyInstance,
            @Nonnull MobSpawnType mobSpawnType, @Nullable SpawnGroupData spawnGroupData, @Nullable CompoundTag tag) {
                ...
                if (d0 < 4.0D) {
                    ...
                    if (this.attackTime <= 0) {
                        ...
                        if (this.attackStep > 1) {
                            ...
                            //             d3, d4, (int) this.piglich.getHealth());
                            //     largeFireball.setPos(this.piglich.getX() + vec3.x * 4.0D,
                            //             this.piglich.getY(0.5D) + 0.5D, largeFireball.getZ() + vec3.z * 4.0D);
